...
func enable_battle_stage() -> void:
	...
	GameManager.get_enemy_to_battle().global_position = enemy_foot_mark_sprite_2d_2.global_position
...
func tween_character_for_attack() -> void:
	...
	the_tween.tween_property(GameManager.get_main_player(), "global_position", GameManager.get_enemy_to_battle().global_position, DURATION)
...
func tween_player_to_reset_position() -> void:
	...
	if the_tween:
		the_tween.kill()
	the_tween = create_tween()
	the_tween.tween_property(GameManager.get_main_player(), "global_position", player_foot_mark_sprite_2d.global_position, DURATION)
	the_tween.finished.connect(_on_the_tween_completed)
...
func tween_enemy_for_attack() -> void:
	...
	if the_tween:
		the_tween.kill()
	the_tween = create_tween()
	the_tween.tween_property(GameManager.get_enemy_to_battle(), "global_position", GameManager.get_main_player().global_position, DURATION)
	the_tween.finished.connect(_on_the_tween_completed)
...
func tween_enemy_to_reset_position() -> void:
	...
	if the_tween:
		the_tween.kill()
	the_tween = create_tween()
	the_tween.tween_property(GameManager.get_enemy_to_battle(), "global_position", enemy_foot_mark_sprite_2d_2.global_position, DURATION)
	the_tween.finished.connect(_on_the_tween_completed)
